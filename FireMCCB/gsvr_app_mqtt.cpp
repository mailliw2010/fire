...
// after new mqtt
void gmqtt::initialize(quint16 port, QString host, QString _user, QString _pass)
{
...
void gmqtt::connectmqtt(QString user, QString pass)
{
    /********Set mqtt***************/
...
int gmqtt::subscribmqtt(QString _topic)
{
...
void gmqtt::publishMesg(uint32_t seq_Num, const QString &topic, const QString &message)
{
    ...
    /**Add Topic here***/
    QString TotalTopic = _pubvar::Topic_Head + topic;
